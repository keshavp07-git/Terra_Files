resource "aws_instance" "web" {
  ...
  provisioner "local-exec" {
    command = "echo $(public_ip) > public_ip.txt" # command to execute in local machine
...
output "public_ip" {
  description = "value of public ip"                           # description of public ip
  value       = aws_instance.web.public_ip # public ip value of the instance
  # public ip value is taken from the instance resource
}

output "private_ip" {
  description = "value of private ip"                           # description of public ip
  value       = aws_instance.web.private_ip # public ip value of the instance
  # public ip value is taken from the instance resource
}
